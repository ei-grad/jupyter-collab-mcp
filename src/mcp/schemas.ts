...
export const TOOL_SPECS: readonly ToolSpec[] = [
  ...
  },
  {
    ...
    title: 'Read a run',
    description:
      `State of a job plus the outputs after cursor; with wait_ms it waits for the next change instead of polling. When outputs_reset is true, replace that cell's prior outputs; an updated stream/display snapshot can repeat previously delivered text. ${NOT_A_TOOL_ERROR} Takes no request_id.`,
    input: z.object({
